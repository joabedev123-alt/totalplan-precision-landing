        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-up opacity-0" style={{ animationDelay: "0.4s", animationFillMode: "forwards" }}>
            <Button variant="cta" size="xl" asChild>
              <a href="mailto:vendas@rfcampanaro.com.br" className="group">
                Solicitar Orçamento
          ...
          {/* Phone */}
          <div className="mt-8 animate-fade-up opacity-0" style={{ animationDelay: "0.5s", animationFillMode: "forwards" }}>
            <a
            ...
            >
              ...
              <span className="text-lg font-medium">(19) 99482-6736</span>
            </a>
          </div>
        </div>
      </div>
